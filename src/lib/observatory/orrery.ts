 ...
 * gets. 3.4 -> 6.2 was still not enough on his screen (third report), so
 * 6.2 -> 9.0. Every outer orbit shifts out with it, since they are computed
 * cumulatively from this one. */
export const ORRERY_SUN_CLEARANCE = 9.0;
