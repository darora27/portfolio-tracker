...
function recordMessages(page, scope) {
...
recordMessages(page, "motion-allowed");
...
recordMessages(reducedPage, "reduced-motion");
await suppressFirstVisit(reducedPage);
const reducedResponse = await reducedPage.goto(base, { waitUntil: "networkidle" });
