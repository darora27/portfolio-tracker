...
const OUT = path.resolve("docs/phase10-baseline/section-11/raw-remediation-mob11.json");
...
for (const width of [390, 320]) {
  ...
  await page.screenshot({ path: `docs/phase10-baseline/section-11/raw-remediation-fallback-${width}.png`, fullPage: true });
  await page.close();
  await context.close();
}
