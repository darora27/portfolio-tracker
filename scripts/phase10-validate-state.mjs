...
require_(/^§(1[0-6]|[2-9])$/.test(state.current_section), `current_section "${state.current_section}" is not §2-§16`);
...
if (state.status === "complete") {
  require_(state.current_section === "§16", "status complete requires current_section §16");
